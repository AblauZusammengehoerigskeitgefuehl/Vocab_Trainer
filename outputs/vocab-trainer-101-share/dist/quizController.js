// @ts-nocheck
import { answerFor, canShowVerbDetails, conjugationText, promptFor, } from "./core.js";
export class QuizController {
    ...
    emptyView() {
        if (!this.state.datasets.length)
            return `<section class="panel"><p>Import a dataset before starting a quiz.</p></section>`;
        if (!this.state.quizSession)
            return `<section class="panel"><p>Select datasets and start a quiz.</p></section>`;
